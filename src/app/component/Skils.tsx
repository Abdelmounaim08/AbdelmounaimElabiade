...
function Skils() {
  const techStack = [
    ...
    { name: 'WooCommerce', detail: 'E-commerce stores' },
    { name: 'Cyber Panel', detail: 'Server and hosting management' },
    { name: 'Claude AI', detail: 'AI-assisted development' },
    { name: 'AI Agents', detail: 'Automation and intelligent workflows' },
    { name: 'n8n', detail: 'No-code automation pipelines' },
    { name: 'Shopify', detail: 'Storefront and app development' },
    { name: 'Polaris', detail: 'Shopify admin UI design' },

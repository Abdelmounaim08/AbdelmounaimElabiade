    ...
    <section id="ABOUT" className="px-5 py-24 sm:px-8 lg:px-12 lg:py-32">
      <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-[0.78fr_1.22fr] lg:gap-24">
        ...
        <div className="reveal" style={{ transitionDelay: "120ms" }}>
          ...
          <p className="text-muted mt-6 max-w-2xl text-base leading-8">{t.about.paragraph1}</p>
          <p className="text-muted mt-4 max-w-2xl text-base leading-8">{t.about.paragraph2}</p>

          <div className="mt-10 flex flex-wrap gap-2.5">
            {t.about.chips.map((item) => (
              <span
                key={item}

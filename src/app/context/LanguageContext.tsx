...
const translationSets: Record<Language, TranslationSet> = {
  fr: {
      ...
      items: [
        {
          ...
          achievements: ["Solutions web livrées en production", "Automatisations intégrées aux workflows métier", "Interfaces et parcours optimisés pour les utilisateurs"],
        },
        {
          period: "2024 — 2025",
          ...
          achievements: ["Plateformes et tableaux de bord réalisés", "Boutiques e-commerce mises en ligne", "Accompagnement direct sur les besoins business et UX"],
        },
      ],
    },
    projects: {
    ...
    contact: {
      ...
      error: "L'envoi a échoué. Vérifiez les champs puis réessayez.",
  ...
  en: {
      ...
      items: [
        {
          ...
          achievements: ["Web solutions delivered to production", "Automation integrated into business workflows", "Interfaces and user journeys optimized"],
        },
        {
          period: "2024 — 2025",
          ...
          achievements: ["Platforms and dashboards delivered", "E-commerce stores launched", "Direct support for business and UX requirements"],
        },
      ],
    },
    projects: {
    ...
    contact: {
      ...
      sending: "Sending...",
      error: "Sending failed. Check the fields and try again.",
